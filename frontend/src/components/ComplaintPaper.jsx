...
const ComplaintPaper = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Backend returns { report_id, master_id, ai_explanation, message }
      setTicketId(result.master_id || result.report_id || 'CIV-' + Date.now());
    } catch (error) {
              ...
              <form onSubmit={handleSubmit} className="paper-form">
                ...
                <div className="paper-actions">
                  <div className="media-group">
                    <Button variant="primary" className="icon-btn" style={{ background: 'var(--primary)', color: 'white', borderColor: 'var(--primary)' }}>
                      <Mic size={18} /> Ask AI
                    </Button>
                    <Button variant="ghost" className="icon-btn" onClick={() => setImageAttached(true)}>
        ...
        {step === 'submitted' && (
          ...
          >
            ...
            <Button 
              ...
              fullWidth
              style={{ margin: '1rem auto 0', justifyContent: 'center' }}
              onClick={resetForm}
            >
